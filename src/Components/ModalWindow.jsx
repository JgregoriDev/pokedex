...
const ModalWindow = ({ pokemonFiltrat, showModal, onButtonClick }) => {
  ...
  const dynamiqueContentPokemon = key => {
    const valores = {
      Types:
        pokemonFiltrat.types.length === 1 ? (
          <span
            style={{
              backgroundColor: pokemonTypes[pokemonFiltrat?.types[0].type.name],
            }}>
          ...
          <p>
            <span
              style={{
                backgroundColor:
                  pokemonTypes[pokemonFiltrat?.types[0].type.name],
              }}>
              {pokemonFiltrat?.types[0].type.name}
            </span>{" "}
            {}
            <span
              style={{
                backgroundColor:
                  pokemonTypes[pokemonFiltrat?.types[1].type.name],
              }}>
              {pokemonFiltrat?.types[1].type.name}
            </span>
          </p>
        ),
      Stats: {
      ...
      Abilities:
        pokemonFiltrat.abilities.length === 1
  ...
  return (
    <div style={modalWindow}>
      ...
      <div
        ...
        <img
          style={img}
          src={pokemonFiltrat?.sprites.front_default}
          alt={pokemonFiltrat.name}
        />
        <div
          style={{
            display: "flex",
            flexDirection: window.innerWidth < 678 ? "column" : "row",
            gap: "3px",
          }}>
          <button
            className="button"
          ...
          <button
            ...
            onClick={() =>
              setShowElement({
                type: false,
                stats: false,
                abilities: !showElement.abilities,
              })
            }
            title="Abilities">
            Abilities
        ...
        <div>
          <div
            style={{
              display: !showElement.type ? "none" : "block",
              marginTop: "20px",
            }}>
            <h6>Types</h6>
          ...
          <div
            style={{
              display: !showElement.stats ? "none" : "block",
              marginTop: "20px",
            }}>
            <h6>Stats</h6>
            <table>
          ...
          <div
            style={{
              display: !showElement.abilities ? "none" : "block",
              marginTop: "20px",
            }}>
            <h6>Abilities</h6>
